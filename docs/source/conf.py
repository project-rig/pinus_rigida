...
from pynn_spinnaker import __version__ as version
...
intersphinx_mapping = {'python':  ('http://docs.python.org/3', None),
                       ...
                       'rig':     ('http://rig.readthedocs.io/en/stable/', None),}
...
local_module_path = pynn_spinnaker.__file__
github_module_path = "pynn_spinnaker/"
github_repo = "project-rig/pynn_spinnaker"
...
htmlhelp_basename = 'pynn_spinnaker_doc'
...
latex_documents = [
    ('index', 'pynn_spinnaker.tex', u'PyNN SpiNNaker Documentation',
     AUTHORS, 'manual'),
]
...
man_pages = [
    ('index', 'pynn_spinnaker', u'PyNN SpiNNaker Documentation',
     [AUTHORS], 1)
]
